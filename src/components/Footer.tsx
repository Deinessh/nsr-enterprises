...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#E2EFFF] text-brand-dark pt-16 pb-20 border-t-2 border-brand-blue/30 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-brand-blue/20">
          ...
          <div className="lg:col-span-4 space-y-4">
            <Link to="/" className="inline-block">
              <img 
                ...
                className="h-16 sm:h-20 lg:h-24 w-auto max-h-24 object-contain" 
              />
            </Link>
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-white border border-brand-blueBorder hover:border-brand-blue text-brand-blue flex items-center justify-center shadow-sm transition-all hover:scale-105"
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center text-xs text-brand-muted space-y-4 sm:space-y-0 font-medium">
          <p>© {new Date().getFullYear()} NSR Enterprises. All Rights Reserved. Bio Septic Tanks & STP Solutions Tamil Nadu.</p>
          <button
            onClick={scrollToTop}
            className="flex items-center space-x-2 text-brand-dark font-bold hover:text-brand-blue transition-colors bg-white px-3.5 py-1.5 rounded-xl border border-brand-blueBorder shadow-sm"
          >
